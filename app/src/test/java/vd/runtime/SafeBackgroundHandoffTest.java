...
public class SafeBackgroundHandoffTest {
    static final class Fake implements SafeBackgroundHandoff.Backend {
        ...
        @Override public Object createStaging() { events.add("create"); return staging; }
        ...
        @Override public void checkSource(int id) { events.add("source" + id); }
        @Override public void checkDestination(int id) {
            events.add("destination" + id);
            if (destinationUnknown) throw new IllegalStateException("identity changed");
            assertEquals(id, moved);
        }
        ...
        @Override public void hide(int id) { events.add("hide" + id); }
        @Override public void relocateAndRestore(int id, Object value) {
            ...
            if (applyThrows) throw new IllegalStateException("reply lost");
        }
    ...
    @Test public void successfulSequenceChecksBeforeMutationAndDeletesOnlyAfterCompletion() throws Exception {
        ...
        assertEquals(Arrays.asList("preflight", "focus", "create", "focus",
                ...
                "stage", "apply8", "destination8", "focus", "stage",
                "focus", "delete", "focus"), fake.events);
